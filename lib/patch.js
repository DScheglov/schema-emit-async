 ...
 */
if (!EventEmitter.prototype.emitAsync || !(EventEmitter.prototype.emitAsync instanceof Function)) {
  ...
  if (mongoose) {
     ...
     */
     if(!mongoose.Schema.prototype.when || !(mongoose.Schema.prototype.when instanceof Function)) {
     ...
     */
    if (!mongoose.Document.prototype.emitAsync || !(mongoose.Document.prototype.emitAsync instanceof Function)) {
